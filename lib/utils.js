...
exports.deepExtend = function() {
	...
	extensions.forEach(function(object) {
		Object.keys(object).forEach(function(key) {
			var value = object[key];
			if (Array.isArray(value)) {
				target[key] = exports.deepExtend([], value);
			} else if (isSimpleObject(value)) {
				target[key] = exports.deepExtend(
					isSimpleObject(target[key]) ? target[key] : {}, value
				);
			} else {
				target[key] = value;
			}
